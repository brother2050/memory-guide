...
ENCODINGS = [
    ...
    ("03", "three-legged stool", "三条腿的凳子", "Chinese landscape"),
    ("04", "pile of snacks chips", "一堆零食", "colorful illustration"),
    ("05", "pentagon shaped talisman", "五边形的神秘咒符", "Chinese fantasy"),
    ...
    ("19", "clothes hook", "挂衣服的钩子", "Chinese medicine"),
    ...
    ("56", "snail crawling slowly", "蜗牛慢慢爬", "landscape"),
    ...
    ("69", "Ryukyu islands scenery", "琉球群岛风光", "Chinese medicine"),
    ...
    ("73", "American ginseng slices", "花旗参切片泡水", "food illustration"),
    ...
    ("85", "white house cottage", "白色小屋", "cute cartoon"),
    ...
    ("90", "red autumn forest", "红叶秋林美景", "fantasy illustration"),

...
| 数字 | 谐音词 | 画面 | 配图 | 备选谐音 |
|------|--------|------|------|----------|
| 00 | 🔔铃铛侠 | 铃铛侠砸金蛋 | ![img](../images/00.jpg) | 零零、铃铛 |
| 01 | 灵药 | 精灵药草 | ![img](../images/01.jpg) | 零一、灵异 |
...
| 19 | 🍶药酒 | 倒药酒喝 | ![img](../images/19.jpg) | 一九、药酒 |
...
| 33 | 📸闪光灯 | 闪光灯咔嚓闪烁 | ![img](../images/33.jpg) | 三三、闪闪 |
...
| 56 | 🌳梧桐树 | 梧桐树下乘凉 | ![img](../images/56.jpg) | 五六、梧桐 |
...
| 73 | 🥚鸡蛋 | 鸡蛋打碎 | ![img](../images/73.jpg) | 七三、鸡蛋 |
...
| 80 | 🐦百灵鸟 | 百灵鸟鸣叫 | ![img](../images/80.jpg) | 八零、百灵 |
...
| 85 | 💎宝物 | 挖出宝箱 | ![img](../images/85.jpg) | 八五、宝物 |
...
| 90 | 🧚精灵 | 精灵施魔法 | ![img](../images/90.jpg) | 九零、精灵 |
...
| 96 | 🍜酒楼 | 酒楼点菜 | ![img](../images/96.jpg) | 九六、酒楼 |
...
|-----------|---|---|---|---|---|---|---|---|---|---|
| **0** | 铃铛侠 | 灵药 | 铃儿 | 灵山 | 零食 | 灵符 | 领路 | 令旗 | 溜溜鞋 | 菱角 |
| **1** | 衣领 | 筷子 | 婴儿 | 医生 | 钥匙 | 鹦鹉 | 石榴 | 试管 | 腰包 | 药酒 |
| **2** | 耳环 | 鳄鱼 | 鸭子 | 和尚 | 闹钟 | 二胡 | 河流 | 耳机 | 恶霸 | 阿胶 |
| **3** | 三轮 | 鲨鱼 | 扇儿 | 闪光灯 | 山寺 | 珊瑚 | 山路 | 山鸡 | 妇女 | 三角 |
| **4** | 司令 | 司仪 | 事儿 | 石山 | 石寺 | 师父 | 饲料 | 司机 | 石板 | 石臼 |
| **5** | 武功秘籍 | 工人 | 鼓儿 | 午餐肉 | 武士 | 火车 | 梧桐树 | 武器 | 尾巴 | 五角星 |
| **6** | 榴莲 | 儿童 | 牛儿 | 流沙 | 螺丝 | 锣鼓 | 溜溜球 | 绿旗 | 牛排 | 琉球 |
| **7** | 麒麟 | 洗衣 | 企鹅 | 鸡蛋 | 骑士 | 积木 | 犀牛 | 蛐蛐 | 西瓜 | 气球 |
| **8** | 百灵鸟 | 蚂蚁 | 靶儿 | 花生 | 拔丝 | 宝物 | 八路 | 白棋 | 爸爸 | 芭蕉 |
| **9** | 精灵 | 球衣 | 球儿 | 旧伞 | 教室 | 救护车 | 酒楼 | 旧旗 | 酒吧 | 舅舅 |
...
| 错误 | 表现 | 正确做法 |
|------|------|----------|
| 直接套用他人编码 | 用别人的谐音编码，画面不熟悉，回忆时卡壳 | 基于自己的生活经验修改编码，确保画面生动且个人化 |
| 忽略区分度 | 相似数字编码雷同（如13和31都用同类画面），回忆时混淆 | 确保每对相似数字的编码有明显差异，可加入颜色或动作区分 |
| 只看不练 | 看完编码表就以为记住了，实际回忆时反应很慢 | 每天随机抽10个数字进行闪卡练习，直到看到数字<1秒出画面 |
...
**Q: 两位数编码需要全部记住吗？**
A: 不需要一次性全部记住。建议分阶段掌握：第一周先记住00-25（高频出现），第二周扩展到49，第三周覆盖全部100个。关键是每个编码都要形成清晰的心理画面，宁可记少记牢，不要贪多嚼不烂。

**Q: 谐音派和视觉派哪个好？**
A: 没有绝对的好坏，取决于你的思维类型。**听觉型**学习者用谐音派更自然（如13=医生，谐音"一生"）；**视觉型**学习者用形状联想法更直观（如11=筷子）。建议先都试试，选一个坚持练习，也可以混合使用——对容易谐音的数字用谐音，不好谐音的用形状。

**Q: 编码冲突怎么办？**
A: 编码冲突是指两个不同编码系统对同一个数字产生了不同的画面。解决方法：①以你最常用的系统为主，另一个系统的编码做"备选"标记；②在不同场景使用不同系统（如记忆电话号码用一套，记忆历史年份用另一套）；③最根本的方法是建立个人统一编码表，所有系统共用同一套画面。

### 🗺️ 进阶路线图

- 想深入学习数字编码底层原理 → [数字基础理论](01-number-basics-01.md)
